...
Create an ordinary Domain value when a page, scene, or session needs an independent execution
identity that can be released when that owner is no longer used. Pass a shared reference when
selecting it:
