...
conditional imports use namespace-valued aliases; see [Const and Comptime](/language/const-and-comptime/).
...
Use single quotes for characters and double quotes for strings. There is no implicit conversion between them.
